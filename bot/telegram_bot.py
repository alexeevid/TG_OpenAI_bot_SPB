# Thin orchestration module: builds Application and registers handlers using legacy functions.
from telegram.ext import Application, CommandHandler, MessageHandler, CallbackQueryHandler, filters
from bot.settings import settings
from bot.legacy.telegram_legacy import (
    start, help as help_cmd, stats, kb_menu, kb_cb,
...
def build_app():
    ...
    app_.add_handler(CommandHandler("kb", kb_menu))
