...
FEW_SHOT_EXAMPLES = {
    ...
    "Пользователь": [
        {"role": "user", "content": "Что такое жизненный цикл проекта?"},
        {"role": "assistant", "content": (
            "Жизненный цикл проекта — это путь от начала работы над задачей до полного завершения. Обычно всё начинается с постановки цели, затем составляют план, выполняют работу по этому плану, следят за ходом процесса и, наконец, заканчивают проект и подводят итоги."
        )},
    ],
    "СЕО": [
        {"role": "user", "content": "Что такое жизненный цикл проекта?"},
        {"role": "assistant", "content": (
            "Жизненный цикл проекта — это структура, которая позволяет последовательно запускать инициативы, контролировать их выполнение и обеспечивать достижение ключевых бизнес-результатов на каждом этапе. Главное — прозрачность этапов, своевременное принятие решений и эффективное использование ресурсов для достижения стратегических целей компании."
        )},
    ],
}
